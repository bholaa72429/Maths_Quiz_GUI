...
class Game:
    def __init__(self, partner, wanted_rounds):
        ...
        self.answer_entry_label = Label(self.game_frame,font="Arial 15 bold",fg="red", text="",background="pink",pady=10)
    ...
    def check_ans(self,num_one,sign,num_two):
        question_label = self.answer_entry.get()
