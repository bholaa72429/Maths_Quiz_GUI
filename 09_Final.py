...
class Game:
    def __init__(self, partner, wanted_rounds):
        ...
        self.quiz_note = Label(self.game_frame, font="Arial 10 italic",
                                       text="Welcome to basic maths quiz! " \
                                            "NOTE: For division round your answer to the nearest one.",
        ...
        # Submit Button
        self.submit_button = Button(self.submit_next_frame, text="Submit", font="Arial 15 bold", bg="#00FA9A", width=10,
                                    command=self.check_ans)
        self.submit_button.grid(column=0,row=8, pady=10, padx=10)

        # Next Button
        self.next_button = Button(self.submit_next_frame, text="Next", font="Arial 15 bold", bg="#00FA9A", width=10,
                                  command=self.try_again)
        self.next_button.grid(column=1,row=8, pady=10, padx=10)

        self.answer_entry_label = Label(self.game_frame, font="Arial 15 bold", fg="blue", text="", pady=10)
    ...
    def try_again(self):
        ...
        self.rounds_label.configure(text="Number of Rounds Left : {}".format(round))
...
class Help:
    ...
    def __init__(self, partner):
        ...
        help_text = "Welcome to the Great Maths Quiz" \
                    ...
                    " FOR THE DIVISION QUESTION ROUND YOUR ANSWER TO THE NEAREST ONE.\n\n" \
                    ...
                    "You can check your stats by clicking on the button, there is also export button for you to save your stats info. \n" \
